...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/kw4v5izcn6dna8s8chni7p5p16tryvzfj22zjvu9uhmvw9jn/tinymce/6/tinymce.min.js"
            referrerpolicy="origin"></script>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body
    class="bg-gradient-to-br from-[#121212] via-[#2d0b0b] to-[#121212] min-h-screen font-sans antialiased text-slate-200">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            <div class="flex items-center gap-3">
                <div
                    class="w-9 h-9 rounded-xl bg-gradient-to-tr from-[#FF2D20] to-rose-600 flex items-center justify-center text-white font-black shadow-lg shadow-red-500/30">
                    LC
                </div>
